var passport = require('passport-strategy')
    , auth_hdr = require('passport-jwt/lib/auth_header')
    , util = require('util')
    , url = require('url')
    , assign = require('passport-jwt/lib/helpers/assign');
 ...
 */
JwtStrategy.JwtVerifier = require('passport-jwt/lib/verify_jwt');
